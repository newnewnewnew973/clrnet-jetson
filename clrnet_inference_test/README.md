...
- 공식 CLRNet 소스(`/home/{디렉토리}/workspace/clrnet`)는 수정하지 않습니다.
...
clrnet_inference_test/
  ...
  data/CULane -> /home/newnew/workspace/data/CULane
  outputs/                            # 실행 결과 저장
```
...
이 workspace는 Apache License 2.0 기준으로 공개할 수 있게 정리했습니다.
...
/home/{디렉토리}/workspace/clrnet_inference_test/data/CULane
```

준비 방법:

```bash
mkdir -p /home/{디렉토리}/workspace/data
```

CULane 압축 파일을 풀어서 아래 구조가 되도록 배치합니다.

```text
/home/{디렉토리}/workspace/data/CULane/driver_xx_xxframe
/home/{디렉토리}/workspace/data/CULane/laneseg_label_w16
/home/{디렉토리}/workspace/data/CULane/list
```

그 다음 이 프로젝트 안에 symlink를 만듭니다.

```bash
mkdir -p /home/{디렉토리}/workspace/clrnet_inference_test/data

ln -s /home/{디렉토리}/workspace/data/CULane \
  /home/{디렉토리}/workspace/clrnet_inference_test/data/CULane
```
...
```bash
mkdir -p /home/{디렉토리}/workspace/weights
```

`culane_dla34.pth`를 `weights` 폴더에 직접 배치한 뒤 확인합니다.

```bash
ls /home/{디렉토리}/workspace/weights/culane_dla34.pth
```
...
python clrnet_inference_test/scripts/inference_culane_dla34.py \
  --image /home/{디렉토리}/workspace/clrnet_inference_test/assets/images/test.jpg \
  --device cuda
```
...
```bash
mkdir -p /home/{디렉토리}/workspace/clrnet_inference_test/assets/images

cp /home/{디렉토리}/workspace/data/CULane/.../이미지.jpg \
  /home/{디렉토리}/workspace/clrnet_inference_test/assets/images/test.jpg
```
